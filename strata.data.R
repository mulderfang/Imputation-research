...
#----------------------------
# y 105 year
y105_8620_notax_1 <- strata.data(y105_8620_notax$EMP, h = 2 ,   n=1000 )
y105_8620_notax_2 <- strata.data(y105_8620_notax$REV, h = 2 ,   n=1000 )
y105_8620_notax_3 <- strata.data(y105_8620_notax$ASSET, h = 2 , n=1000 )
