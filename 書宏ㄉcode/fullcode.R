...
#cut data
load("data/y100.rda")
y100_7402 = y100[which(y100$IND == 7402),]
save(y100_7402, file = "data/y100_7402.rda")

load("data/y105.rda")
y105_7402 = y105[which(y105$IND == 7402),]
save(y105_7402, file = "data/y105_7402.rda")

### scatterplot
load("data/y100_7402.rda")
load("data/y105_7402.rda")
